page 50003 "Cust Point / Comm Update"
{
        ...
        area(content)
        {
            ...
            field(ProdGroupcode; ProdGroupcode)
            {
                ...
                begin
                    ...
                    IF NOT ValidateProductGroup(ProdGroupcode) THEN BEGIN
    ...
    var
        ...
        Year: Option "2007","2008","2009","2010","2011","2012","2013","2014","2015","2016","2017","2018","2019","2020","2021","2022","2023","2024","2025","2026","2027","2028","2029","2030";
        LastMonth: Integer;
        ThisYear: Integer;
        LastMonthDate: Date;
        CreateTempTable: Codeunit CreateTempTable;
        MonthInteger: Integer;
        YearInteger: Integer;
        "Start Date": Date;
        "End Date": Date;
        TempTable: Record "Temp Table";
        TransactionTable: Record "Customer Point & Commission";
    ...
    begin
        ...
        ELSE BEGIN
            ...
            IF TempTable.FIND('-') THEN BEGIN
                ...
                IF TransactionTable.FIND('-') THEN BEGIN
    ...
    begin
        ...
        IF (CustomerCode <> '') AND (Point <> 0) THEN BEGIN
    ...
    var
    // Note: Product Group table is BC discontinued table
