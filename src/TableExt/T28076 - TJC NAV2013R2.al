table 28076 "Purch. Tax Inv. Line"
{
    ...
    fields
    {
        ...
        {
            Caption = 'GST Calculation Type';
            OptionCaption = 'Normal GST,Reverse Charge GST,Full GST,Sales Tax';
        ...
        {
            Caption = 'Paid Amount Incl. GST';
        }
        field(28071;"Paid VAT";Decimal)
        {
            Caption = 'Paid GST';
        }
        field(28073;"External Document No.";Code[20])
        {
    ...
    trigger OnDelete()
    begin
        // DimMgt.DeletePostedDocDim(DATABASE::"Purch. Inv. Line","Document No.","Line No.");
    end;
    ...
    procedure CalcVATAmountLines(var PurchInvHeader: Record "122";var VATAmountLine: Record "290")
    begin
    ...
    begin
        ...
        //   FORM.RUNMODAL(FORM::Page138,PurchInvHeader);
    end;
}
