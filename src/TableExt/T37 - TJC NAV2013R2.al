...
{
    // TJCRMS1.00  DP.SWJ
    //   #1 Add new fields for RMS Integration
    //      - Disc. Reason Code
    //      - Cashier
    //      - Doctor
    ...
    keys
    {
        ...
        key(Key9;"Document Type","Sell-to Customer No.","Shipment No.")
        {
        ...
        key(Key11;"Document Type","Document No.","Qty. Shipped Not Invoiced")
        {
        }
        key(Key12;"Document Type","Document No.",Type,"No.")
        {
        }
    }
    ...
    begin
        ...
        ItemTrackingMgmt.AutoAssignLotNo(Rec,1)
    end;
}
