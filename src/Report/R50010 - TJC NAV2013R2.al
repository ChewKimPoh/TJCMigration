// report 50010 "Posted Sale Invoice"
// {
//     // Version No.          : TJCSG1.00
//     // Deverloper           : DP.NDN
//     // Date of Last Change  : 22/10/2014
//     DefaultLayout = RDLC;
//     RDLCLayout = './Posted Sale Invoice.rdlc';
...
//             {
//             }
//             column(TotalSalesLineLineAmt;TotalSalesLineLineAmt)
//             {
//             }
...
//                 vVATPercentage :=0;
//                 CalculateLineVATPercent(vVATPercentage, "Sales Invoice Header"."No.");
...
//                 //DP.WOOZW 14/06/19 Reset VATAmount and vTotalDiscountAmount for multiple printing
//                 CLEAR(VATAmount);
//                 CLEAR(vTotalDiscountAmount);
//                 CLEAR(TotalSalesLineLineAmt);
//                 CLEAR(TotalExclVAT);
//                 CLEAR(TotalInclVAT);
//                 //
//                 rSIL.RESET;
...
//                   REPEAT
//                     //DP.WOOZW 14/06/19 Removed and calculate via difference of Amount Incl. VAT and Amount
//                     //VATAmount := VATAmount + (rSIL."VAT %"*rSIL."Line Amount"/100);
//                     VATAmount += rSIL."Amount Including VAT" - rSIL.Amount;
//                     TotalSalesLineLineAmt += rSIL."Line Amount";
//                     //
//                     vTotalDiscountAmount += rSIL."Inv. Discount Amount";
//                   UNTIL rSIL.NEXT=0;

//                 //DP.WOOZW 14/06/19 Calc totals
//                 TotalExclVAT := TotalSalesLineLineAmt - vTotalDiscountAmount;
...
//         SalesInvLine.SETFILTER(Type,'%1|%2|%3',SalesInvLine.Type::Item,SalesInvLine.Type::"G/L Account",SalesInvLine.Type::"Charge (Item)");
//         IF SalesInvLine.FINDFIRST THEN
//         REPEAT
//           rVATProdSetup.RESET;
//           rVATProdSetup.SETRANGE("VAT Bus. Posting Group","Sales Invoice Header"."VAT Bus. Posting Group");
//           rVATProdSetup.SETRANGE("VAT Prod. Posting Group",SalesInvLine."VAT Prod. Posting Group");
