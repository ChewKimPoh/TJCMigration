// report 50038 "Order Confirmation TJC"
// {
//     DefaultLayout = RDLC;
//     RDLCLayout = './Order Confirmation TJC.rdlc';
...
//             {
//             }
//             column(ShipTo_1;ShipTo[1])
//             {
//             }
//             column(ShipTo_2;ShipTo[2])
//             {
//             }
//             column(ShipTo_3;ShipTo[3])
//             {
//             }
//             column(ShipTo_4;ShipTo[4])
//             {
//             }
//             column(ShipTo_5;ShipTo[5])
//             {
//             }
//             column(ShipTo_6;ShipTo[6])
//             {
//             }
//             column(ShipTo_7;ShipTo[7])
//             {
//             }
//             column(ShipTo_8;ShipTo[8])
//             {
//             }
//             column(SalesHeader_PostingDate;FORMAT("Sales Header"."Posting Date"))
//             {
//             }
...
//                     {
//                         DataItemTableView = SORTING(Number);
//                         column(ItemTracking_LotNo;ItemTracking."Lot No.")
//                         {
//                         }
//                         column(Item_ShelfNo;rItem."Shelf No.")
//                         {
//                         }
//                         column(seqNo;seqNo)
//                         {
...
//                         {
//                         }
//                         column(vVATPercentage;vVATPercentage)
//                         {
//                         }
//                         column(vVATPercentageText;vVATPercentageText)
//                         {
//                         }
...
//                             //get Shelf No.
//                             rItem.RESET;
//                             IF "Sales Line".Type = 2 THEN
//                               IF rItem.GET("Sales Line"."No.") THEN;
...
//                                 IF NOT TempItemTrack.FIND('-') THEN BEGIN
//                                 //>>SWJ
//                                   TempItemTrack.INIT;
...
//                   GLSetup.TESTFIELD("LCY Code");
//                   TotalText := STRSUBSTNO(Text001,GLSetup."LCY Code");
//                   TotalInclVATText := STRSUBSTNO(TJCText002,GLSetup."LCY Code");
//                   TotalExclVATText := STRSUBSTNO(TJCText001,GLSetup."LCY Code");
//                 END ELSE BEGIN
//                   TotalText := STRSUBSTNO(Text001,"Currency Code");
//                   TotalInclVATText := STRSUBSTNO(TJCText002,"Currency Code");
//                   TotalExclVATText := STRSUBSTNO(TJCText001,"Currency Code");
//                 END;

//                 // DD#752 - Show GST % by DP.HAN on 05,Jan 2024
//                 CLEAR(vVATPercentage);
//                 vVATPercentage :=0;
//                 CalculateLineVATPercent(vVATPercentage, "Sales Header"."No.");
//                 vVATPercentageText:=FORMAT(ROUND(vVATPercentage,0.1))+ '% GST';
...
//         rItem: Record "27";
//         EntryNo: Integer;
//         TJCText001: Label 'SUB-TOTAL %1';
//         TJCText002: Label 'TOTAL %1';
//         vVATPercentage: Decimal;
//         vVATPercentageText: Text;
...
//     procedure FormatShipTo()
//     begin
//         CLEAR(ShipTo);
//         /*
//         IF "Sales Header"."Ship-to Code" <>'' THEN
//           ShipTo[1] := "Sales Header"."Ship-to Code";
//         */
//         IF "Sales Header"."Ship-to Name" <>'' THEN
//           ShipTo[2] := "Sales Header"."Ship-to Name";

//         IF "Sales Header"."Ship-to Name 2" <>'' THEN
//           ShipTo[3] := "Sales Header"."Ship-to Name 2";

//         IF "Sales Header"."Ship-to Address" <>'' THEN
//           ShipTo[4] := "Sales Header"."Ship-to Address";

//         IF "Sales Header"."Ship-to Address 2" <>'' THEN
//           ShipTo[5] := "Sales Header"."Ship-to Address 2";

//         IF "Sales Header"."Ship-to City" <>'' THEN
//           ShipTo[6] := "Sales Header"."Ship-to City";

//         IF "Sales Header"."Ship-to Post Code" <>'' THEN
//           IF ShipTo[6] <>'' THEN
//             ShipTo[6] := ShipTo[6] +',' + "Sales Header"."Ship-to Post Code"
//           ELSE
//             ShipTo[6] := "Sales Header"."Ship-to Post Code";

//         IF "Sales Header"."Ship-to Country/Region Code" <>'' THEN BEGIN
//           CountryRegion.RESET;
//           IF CountryRegion.GET("Sales Header"."Ship-to Country/Region Code") THEN
//             ShipTo[7] := CountryRegion.Name;
//         END;
//         /*
//         IF "Sales Header"."Ship-to Contact" <>'' THEN
//           ShipTo[8] := 'Attn: '+"Sales Header"."Ship-to Contact"
//         ELSE
//           ShipTo[8] :='';
//         */
...
//     procedure CalculateLineVATPercent(var lVATPercentage: Decimal;DocNo: Code[20])
//     var
//         SalesLine: Record "37";
//         rVATProdSetup: Record "325";
//     begin
//         // DD#752 - Show GST % by DP.HAN on 05,Jan 2024
//         lVATPercentage :=0;
//         SalesLine.RESET;
//         //SalesLine.SETRANGE("Document Type","Sales Invoice Header"."Document Type");
//         SalesLine.SETRANGE("Document No.",DocNo);
//         SalesLine.SETFILTER(Type,'%1|%2|%3',SalesLine.Type::Item,SalesLine.Type::"G/L Account",SalesLine.Type::"Charge (Item)");
//         IF SalesLine.FINDFIRST THEN
//         REPEAT
//           rVATProdSetup.RESET;
//           rVATProdSetup.SETRANGE("VAT Bus. Posting Group","Sales Header"."VAT Bus. Posting Group");
//           rVATProdSetup.SETRANGE("VAT Prod. Posting Group",SalesLine."VAT Prod. Posting Group");
//           IF  rVATProdSetup.FINDFIRST THEN BEGIN
//              IF  rVATProdSetup."VAT %" >  lVATPercentage THEN lVATPercentage:= rVATProdSetup."VAT %";
