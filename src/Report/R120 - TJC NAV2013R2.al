...
// {
//     // wcw 250408 add index for performance
//     // 
//     // Aged Accounts Receivable - 120
//     // Version No.         : TJCSG1.00
//     // Developer           : DP.AYD
//     // Init. DEV. Date     : 28/05/2014
//     // Date of last Change : 28/05/2014
//     // Description         : Based on DD#115 https://dptech.mydonedone.com/issuetracker/projects/4350/issues/115
//     DefaultLayout = RDLC;
...
//                         DetailedCustomerLedgerEntry.SETCURRENTKEY("Cust. Ledger Entry No.","Posting Date");
