...
//     procedure CreateReservEntry(ItemJournalLine: Record "83";Qty: Decimal;SerialNo: Code[20];LotNo: Code[20];ItemTracking: Option "None","Lot No.","Lot and Serial No.","Serial No.")
//     var
//         FoundRec: Boolean;
//     begin
...
//     procedure CreateSummary(var ItemJnlLine1: Record "83")
//     var
