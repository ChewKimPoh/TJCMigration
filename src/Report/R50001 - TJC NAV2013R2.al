// report 50001 "Tax Invoice frm get shipment"
// {
...
//     DefaultLayout = RDLC;
//     RDLCLayout = './Tax Invoice frm get shipment.rdlc';
...
//                 REPEAT
//                   //DP.WOOZW 14/06/19 Use TotalSalesLineLineAmt to sum Line Amount, TotalAmountExclVAT to remove Invoice Discount Amount
//                   //TotalAmountExclVAT += SalesLine."Line Amount";
//                   TotalSalesLineLineAmt += SalesLine."Line Amount";
//                   //
//                   vInvoiceDiscountAmt += SalesLine."Inv. Discount Amount" ;
//                 UNTIL SalesLine.NEXT =0;

//                 //DP.WOOZW 14/06/19
//                 TotalAmountExclVAT := TotalSalesLineLineAmt - vInvoiceDiscountAmt;
//                 //
