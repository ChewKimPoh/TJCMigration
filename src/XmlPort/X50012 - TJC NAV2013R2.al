...
//         textelement(TJCTO)
//         {
//             tableelement(Table5740;Table5740)
//             {
//                 AutoReplace = true;
//                 AutoSave = true;
//                 XmlName = 'TJCTOHeader';
//                 SourceTableView = SORTING(Field1)
//                                   WHERE(Field23=CONST(0));
...
//                     end;
//                 }
//                 tableelement(Table5741;Table5741)
//                 {
...
//                         END ELSE BEGIN
//                         IF TempDimSetEntry.FINDFIRST THEN REPEAT
