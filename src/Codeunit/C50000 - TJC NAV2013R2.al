...
//         Item: Record "27";
//         TempTable: Record "50000" temporary;
//         DBTempTable: Record "50000";
//         EntryNo: Integer;
//         NameCode: Text[20];
//         SalespersonCode: Text[20];
//         PostSalesInvoiceHeader: Record "112";
//         Customer: Record "18";
//         pBar: Dialog;
//         pBarTotal: Integer;
//         pBarCount: Integer;
...
//           /*TJCSG1.00 #4*/ TempTable.SETCURRENTKEY(TempTable."Document No",TempTable."Document Type","Item Code");
...
//         GotPromoter: Boolean;
//         ItemCategoryDescription: Text[50];
//         OpeningAR: Record "50000" temporary;
//         ItemCostPrice: Decimal;
//         ProdCommPaid: Decimal;
//         ProdCommUnpaid: Decimal;
//         TotalProdCommPaid: Decimal;
...
//         /*TJCSG1.00 #4*/ CustLedgerEntry.SETCURRENTKEY("Document Type","Closed at Date","Sell-to Customer No.","Journal Batch Name");
...
//         BEGIN
//           REPEAT
//             /*TJCSG1.00 #6 */ PBarUpdate2(CustLedgerEntry."Document No.",0);
//                //20090529 [
...
//                       /*TJCSG1.00 #6 */ PBarUpdate2(CustLedgerEntry."Document No.",SalesInvoiceLine."Line No.");
//                       //reset for each invoice
//                       "Total Sale":=0;
//                       "Total Production Sale":=0;
...
//                         /*TJCSG1.00 #6*/ User.SETCURRENTKEY("Staff Level");
...
//                  BEGIN
//                    REPEAT
//                      /*TJCSG1.00 #6 */ PBarUpdate2(CustLedgerEntry."Document No.",-1);
//                    //reset for each invoice
//                    "Total Sale":=0;
//                    "Total Production Sale":=0;
...
//           IF DtldCustLedgEntry1.FIND('-') THEN REPEAT
...
//               IF DtldCustLedgEntry2.FIND('-') THEN REPEAT
...
//         //get credit memo that is within the selected date
//         //CreditMemoHeader.SETCURRENTKEY(CreditMemoHeader."Posting Date");
//         /*TJCSG1.00 #6*/ CreditMemoHeader.SETCURRENTKEY("Posting Date","Sell-to Customer No.");
//         CreditMemoHeader.SETRANGE(CreditMemoHeader."Posting Date","Start Date","End Date");
...
//           REPEAT
//             /*TJCSG1.00 #6 */ PBarUpdate2(CreditMemoHeader."No.",-2);
...
//             IF NOT Customer."Exclude from Prod. Comm." THEN BEGIN
//               //20090529 ]
//             /*TJCSG1.00 #6*/ CreditMemoLine.SETCURRENTKEY("Document No.",Type);
//             CreditMemoLine.SETRANGE(CreditMemoLine."Document No.",CreditMemoHeader."No.");
//             //CreditMemoLine.SETRANGE(CreditMemoLine.Type,CreditMemoLine.Type::Item);
...
//                   /*TJCSG1.00 #6 */ PBarUpdate2(CreditMemoHeader."No.",CreditMemoLine."Line No.");
...
//         IF CustomerCode<>'ZTP(TOH GUAN)' THEN
//         BEGIN
