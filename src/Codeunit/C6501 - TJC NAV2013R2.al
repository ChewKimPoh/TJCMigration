...
//         TempGlobalAdjustEntry: Record "337" temporary;
//         TempGlobalEntrySummary: Record "338" temporary;
//         TempGlobalChangedEntrySummary: Record "338" temporary;
//         CurrItemTrackingCode: Record "6502";
//         TempGlobalEntrySummaryFEFO: Record "338" temporary;
//         TempGlobalTrackingSpec: Record "336" temporary;
...
//     procedure AssistEditLotSerialNo(var TrackingSpecification: Record "336" temporary;SearchForSupply: Boolean;CurrentSignFactor: Integer;LookupMode: Option "Serial No.","Lot No.";MaxQuantity: Decimal): Boolean
//     var
...
//     procedure SelectMultipleLotSerialNo(var TrackingSpecification: Record "336" temporary;MaxQuantity: Decimal;CurrentSignFactor: Integer)
//     var
...
//     procedure LookupLotSerialNoAvailability(var TrackingSpecification: Record "336" temporary;LookupMode: Option "Serial No.","Lot No."): Boolean
//     var
//         ItemTrackingSummaryForm: Page "6500";
//         Window: Dialog;
//     begin
...
//     procedure RetrieveLookupData(var TrackingSpecification: Record "336" temporary;FullDataSet: Boolean): Boolean
//     var
//         ItemLedgEntry: Record "32";
//         ReservEntry: Record "337";
//         xTrackingSpecification: Record "336" temporary;
//     begin
...
//     procedure TransferItemLedgToTempRec(var ItemLedgEntry: Record "32";var TrackingSpecification: Record "336" temporary)
//     begin
...
//               END ELSE
//                 TempGlobalReservEntry."Shipment Date" := 12319999D;
...
//     procedure TransferReservEntryToTempRec(var ReservEntry: Record "337";var TrackingSpecification: Record "336" temporary)
//     begin
...
//     procedure CreateEntrySummary(TrackingSpecification: Record "336" temporary;TempReservEntry: Record "337" temporary)
//     var
...
//     procedure CreateEntrySummary2(TrackingSpecification: Record "336" temporary;LookupMode: Option "Serial No.","Lot No.";TempReservEntry: Record "337" temporary)
//     var
//         DoInsert: Boolean;
//     begin
//         TempGlobalEntrySummary.RESET;
...
//     procedure AutoSelectLotSerialNo(var TempEntrySummary: Record "338" temporary;SelectQty: Decimal)
//     var
//         AvailableQty: Decimal;
//     begin
//         IF SelectQty = 0 THEN
...
//     procedure AddSelectedLotSNToDataSet(var TempEntrySummary: Record "338" temporary;var TrackingSpecification: Record "336" temporary;CurrentSignFactor: Integer)
//     var
//         TrackingSpecification2: Record "336" temporary;
//         LastEntryNo: Integer;
...
//     procedure LotSNAvailable(TrackingSpecification: Record "336" temporary;LookupMode: Option "Serial No.","Lot No."): Boolean
//     begin
...
//     procedure HasSamePointer(TrackingSpecification: Record "336";ReservEntry: Record "337"): Boolean
//     begin
...
//     procedure UpdateLotSNDataSetWithChange(var TempItemTrackLineChanged: Record "336" temporary;LineIsDemand: Boolean;CurrentSignFactor: Integer;ChangeType: Option Insert,Modify,Delete)
//     var
//         LastEntryNo: Integer;
//     begin
...
//     procedure UpdateLotSNGlobalChangeRec(var TempItemTrackLineChanged: Record "336" temporary;LineIsDemand: Boolean;CurrentSignFactor: Integer;ChangeType: Option Insert,Modify,Delete) ChangedEntryNo: Integer
//     var
//         NewQuantity: Decimal;
//         LastEntryNo: Integer;
//     begin
...
//     procedure UpdateCurrentPendingQty()
//     var
//         TempLastGlobalEntrySummary: Record "338" temporary;
//     begin
//         TempGlobalChangedEntrySummary.RESET;
//         TempGlobalChangedEntrySummary.SETCURRENTKEY("Lot No.","Serial No.");
...
//     procedure UpdateTempSummaryWithChange(var ChangedEntrySummary: Record "338" temporary)
//     var
//         LastEntryNo: Integer;
...
//     procedure RefreshLotSNAvailability(var TrackingSpecification: Record "336" temporary;ShowMessage: Boolean) AvailabilityOK: Boolean
//     var
//         LookupMode: Option "Serial No.","Lot No.";
...
//     procedure UpdateBinContent(var TempEntrySummary: Record "338" temporary)
//     var
...
//     procedure RefreshBinContent(var TempEntrySummary: Record "338" temporary)
//     begin
//         TempEntrySummary.RESET;
//         IF TempEntrySummary.FINDSET THEN
//           REPEAT
...
//     procedure TransferExpDateFromSummary(var TrackingSpecification: Record "336" temporary;var TempEntrySummary: Record "338" temporary)
//     begin
...
//     procedure CreateEntrySummaryFEFO(Location: Record "14";ItemNo: Code[20];VariantCode: Code[10];UseExpDates: Boolean)
//     begin
...
//     local procedure SummarizeInventoryFEFO(Location: Record "14";ItemNo: Code[20];VariantCode: Code[10];HasExpirationDate: Boolean)
//     var
//         ItemLedgEntry: Record "32";
//     begin
...
//             IF "Remaining Quantity" - "Reserved Quantity" > 0 THEN
...
//     local procedure SummarizeAdjustmentBinFEFO(Location: Record "14";ItemNo: Code[20];VariantCode: Code[10])
//     var
...
//     procedure FindFirstEntrySummaryFEFO(var EntrySummary: Record "338"): Boolean
//     begin
//         WITH TempGlobalEntrySummaryFEFO DO BEGIN
//           RESET;
...
//     procedure FindNextEntrySummaryFEFO(var EntrySummary: Record "338"): Boolean
//     begin
//         WITH TempGlobalEntrySummaryFEFO DO BEGIN
//           IF NEXT = 0 THEN
//             EXIT(FALSE);
...
//     procedure AdjustForDoubleEntries()
//     begin
...
//     procedure SumUpTempTrkgSpec(var TempTrackingSpecification: Record "336" temporary;ReservEntry: Record "337")
//     var
//         ItemTrackingMgt: Codeunit "6500";
//     begin
...
//     procedure RelateJnlLineToTempTrkgSpec(var ReservEntry: Record "337";var TempTrackingSpecification: Record "336" temporary)
//     var
...
//     procedure FindRelatedParentTrkgSpec(ItemJnlLine: Record "83";var TempTrackingSpecification: Record "336" temporary;SerialNo: Code[20];LotNo: Code[20]): Boolean
//     begin
...
//     procedure AddToAdjustmentEntryDataSet(var ReservEntry: Record "337";AdjustQty: Decimal)
//     begin
//         IF AdjustQty = 0 THEN
//           EXIT;
...
//     procedure InsertAdjustmentEntries()
//     var
...
//     procedure MaxDoubleEntryAdjustQty(var TempItemTrackLineChanged: Record "336" temporary;var ChangedEntrySummary: Record "338" temporary): Decimal
//     var
//         ItemJnlLine: Record "83";
//     begin
...
//     procedure CheckJobInPurchLine(TrackingSpecification: Record "336"): Boolean
//     var
//         PurchLine: Record "39";
//     begin
...
//     procedure FindLotNoBySN(TrackingSpecification: Record "336"): Code[20]
//     begin
//         IF NOT (PartialGlobalDataSetExists OR FullGlobalDataSetExists) THEN
//           RetrieveLookupData(TrackingSpecification,TRUE);
...
//     local procedure FindLastGlobalEntrySummary(var GlobalChangedEntrySummary: Record "338";var LastGlobalEntrySummary: Record "338")
//     var
//         TempGlobalChangedEntrySummary2: Record "338" temporary;
//     begin
