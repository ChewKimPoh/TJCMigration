...
// {
//     // DP.NCM 27092014 TJC #246: Change Message Prompt for Lot No.
...
//     procedure RunWithCheck(var ItemJnlLine2: Record "83")
//     begin
...
//     local procedure InsertCapValueEntry(var CapLedgEntry: Record "5832";ValueEntryType: Option;ValuedQty: Decimal;InvdQty: Decimal;AdjdCost: Decimal)
//     var
...
//     procedure CostApply(var ItemLedgEntry: Record "32";ItemLedgEntry2: Record "32")
//     var
...
//     procedure ZeroApplication(EntryNo: Integer): Boolean
//     var
...
//     procedure EnsureValueEntryLoaded(var ValueEntry: Record "5802";ItemLedgEntry: Record "32")
//     begin
...
//     procedure UpdateItemApplnEntry(ItemLedgEntryNo: Integer;PostingDate: Date)
//     var
//         ItemApplnEntry: Record "339";
//     begin
...
//           END;
//           GetInvtSetup;
//           IF (ValueEntry."Source Code" = SourceCodeSetup."Adjust Cost") AND NOT "Applied Entry to Adjust" THEN
...
//     procedure GetMaxValuationDate(ItemLedgerEntry: Record "32"): Date
//     var
//         ValueEntry: Record "5802";
//     begin
...
//     procedure UpdateValuationDate(FromValuationDate: Date;FromItemLedgEntryNo: Integer;FromInbound: Boolean)
//     var
...
//     procedure CreateItemJNLLinefromEntry(ItemLedgEntry: Record "32";NewQuantity: Decimal;var ItemJnlLine: Record "83")
//     begin
//         CLEAR(ItemJnlLine);
//         WITH ItemJnlLine DO BEGIN
...
//     local procedure AutoTrack(var ItemLedgEntryRec: Record "32")
//     var
//         ReservMgt: Codeunit "99000845";
//     begin
...
//     local procedure SetupSplitJnlLine(var ItemJnlLine2: Record "83";var PostItemJnlLine: Boolean)
//     var
...
//     procedure CollectValueEntryRelation(var TargetValueEntryRelation: Record "6508" temporary;RowId: Text[100]): Boolean
//     begin
...
//     procedure CollectItemEntryRelation(var TargetItemEntryRelation: Record "6507" temporary): Boolean
//     begin
...
//     local procedure InitCorrItemLedgEntry(OldItemLedgEntry: Record "32";var NewItemLedgEntry: Record "32")
//     var
//         EntriesExist: Boolean;
//     begin
...
//           //DP.NCM 27092014 TJC #246
//             ERROR('Lot No. required for Line No. %1, Item No. %2',ItemJnlLine."Document Line No.",ItemJnlLine."Item No.");
//           //DP.NCM 27092014 TJC #246
...
//     procedure GetPostItemJnlLine(): Boolean
//     begin
...
//     procedure InsertBalanceExpCostRevEntry(ValueEntry: Record "5802")
//     var
...
//     procedure IsBalanceExpectedCostFromRev(ItemJnlLine2: Record "83"): Boolean
//     begin
...
//     procedure CalcRevExpCostToBalance(ValueEntry: Record "5802";InvdQty: Decimal;var RevExpCostToBalance: Decimal;var RevExpCostToBalanceACY: Decimal)
//     var
//         ValueEntry2: Record "5802";
...
//     procedure IsInterimRevaluation(): Boolean
//     begin
//         WITH ItemJnlLine DO
...
//     procedure MoveApplication(var ItemLedgEntry: Record "32";var OldItemLedgEntry: Record "32"): Boolean
//     var
//         Application: Record "339";
//         Enough: Boolean;
...
//     procedure TouchItemEntryCost(var ItemLedgerEntry: Record "32";IsAdjustment: Boolean)
//     var
//         ValueEntry: Record "5802";
//         AvgCostAdjmtEntryPoint: Record "5804";
//     begin
...
//     procedure GetMaxAppliedValuationdate(ItemLedgerEntry: Record "32"): Date
//     var
//         ToItemApplnEntry: Record "339";
...
//     procedure "Max"(Date1: Date;Date2: Date): Date
//     begin
//         IF Date1 > Date2 THEN
//           EXIT(Date1);
//         EXIT(Date2);
...
//     procedure InsertCountryCode(var NewItemLedgEntry: Record "32";ItemLedgEntry: Record "32")
//     begin
...
//     procedure ReservationPreventsApplication(ApplicationEntry: Integer;ItemNo: Code[20];ReservationsEntry: Record "32")
//     var
...
//     procedure GetSourceNo(ItemJnlLine: Record "83"): Code[20]
//     begin
...
//     procedure VerifyInvoicedQty(ItemLedgerEntry: Record "32")
//     var
//         ItemLedgEntry2: Record "32";
//         ItemApplnEntry: Record "339";
...
//     procedure SetupTempSplitItemJnlLine(ItemJnlLine2: Record "83";SignFactor: Integer;var NonDistrQuantity: Decimal;var NonDistrAmount: Decimal;var NonDistrAmountACY: Decimal;var NonDistrDiscountAmount: Decimal;Invoice: Boolean;var PostItemJnlLine: Boolean)
//     var
